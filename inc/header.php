    ...
    <div class="social clear">
        <div class="icon clear">
            ...
            ?>
                ...
                <a href="<?= $result['ln']; ?>" target="_blank"><i class="fa fa-twitter twitter"></i></a>
                <a href="<?= $result['gp']; ?>" target="_blank"><i class="fa fa-linkedin linkedin"></i></a>
                <a href="<?= $result['fb']; ?>" target="_blank"><i class="fa fa-google-plus google-plus"></i></a>
